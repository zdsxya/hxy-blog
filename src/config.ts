...
export const siteConfig: SiteConfig = {
	title: "Hxy's Home", // 站点标题
	subtitle: "secret base", // 站点副标题
	...
	anime: {
		mode: "yuc", // "yuc" 同步季度新番并手动选择公开追番；也支持 "bangumi"、"local"、"bilibili"
	},
	...
	toc: {
		...
		useJapaneseBadge: false, // 使用数字目录标记
	},
